    ...
    internal class Program
    {
        private static void EncryptFile(string source, string destination, string sKey)
        {
            using (FileStream fsInput = new FileStream(source, FileMode.Open, FileAccess.Read))
            {
                ...
                try
                {
                    ...
                    using (FileStream key = new FileStream("C:\\Study\\C#\\Test9\\key.bin", FileMode.Create, FileAccess.Write))
        ...
        private static void Hash()
        {
            using (SHA384 mysha384 = SHA384.Create())
            {
                ...
                hashValue = mysha384.ComputeHash(File.ReadAllBytes("C:\\Study\\C#\\Test9\\Sha.txt"));
                File.WriteAllBytes("C:\\Study\\C#\\Test9\\Hash.txt", hashValue);
            }
        }
        ...
        static void Main(string[] args)
        {
            ...
            while (true)
            {
                ...
                {
                    case "1":
                        EncryptFile("C:\\Study\\C#\\Test9\\File.txt", "C:\\Study\\C#\\Test9\\EncryptedFile.des", Console.ReadLine());
                        break;
                    case "2":
                        DecryptFile("C:\\Study\\C#\\Test9\\EncryptedFile.des", "C:\\Study\\C#\\Test9\\DecryptedFile.txt", Console.ReadLine());
                        break;
                    case "3":
                        Hash();
                        break;
