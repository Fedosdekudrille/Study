namespace Lab2
{
    partial class Customer
    {
        ...
        static public Customer operator +(Customer customer1, Customer customer2)
        {
            return new(customer1.id, customer1.surname, customer1.name, customer1.patronymic, customer1.adress, customer1.creditCard, customer1.money)
            {
                money = customer1.money + customer2.money,
            };
        }
