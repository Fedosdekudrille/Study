...
--------------- Task 3 ---------------
CREATE PFILE='KFA_PFILE.ora' FROM SPFILE;
...
--------------- Task 5   ---------------
CREATE SPFILE ='KFA_SFILE.ora' FROM PFILE= 'KFA_PFILE.ora';
...
SHUTDOWN IMMEDIATE;
startup mount;
ALTER SYSTEM SET SPFILE = 'C:\ImportantThings\DaPofig\database\KFA_SFILE.ORA' SCOPE=BOTH;
STARTUP SPFILE :='C:\ImportantThings\DaPofig\database\KFA_SFILE.ORA';
