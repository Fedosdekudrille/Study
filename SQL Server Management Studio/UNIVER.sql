...
INSERT PULPIT(PULPIT, PULPIT_NAME) VALUES('AAA', 'AAA');
...
insert into SUBJECT   (SUBJECT,   SUBJECT_NAME,PULPIT )
                       values ('ТРИ',    'Технология резиновых изделий','ОХ') 
insert into SUBJECT   (SUBJECT,   SUBJECT_NAME, PULPIT )
...
SELECT AUDITORIUM Аудитория, AUDITORIUM_TYPE.AUDITORIUM_TYPENAME [Тип аудитории]
...
SELECT Au.AUDITORIUM Аудитория, Au_Type.AUDITORIUM_TYPENAME [Тип аудитории]
	From AUDITORIUM As Au, AUDITORIUM_TYPE As Au_Type
	Where Au.AUDITORIUM_TYPE = Au_Type.AUDITORIUM_TYPE;

SELECT Au.AUDITORIUM Аудитория, Au_Type.AUDITORIUM_TYPENAME [Тип аудитории]
	From AUDITORIUM As Au, AUDITORIUM_TYPE As Au_Type
	Where Au.AUDITORIUM_TYPE = Au_Type.AUDITORIUM_TYPE AND Au_Type.AUDITORIUM_TYPENAME Like '%компьютер%';

SELECT FACULTY.FACULTY_NAME Факультет, PULPIT.PULPIT_NAME Кафедра, SUBJECT.SUBJECT_NAME Специальность, PROGRESS.SUBJECT Дисциплина, STUDENT.NAME [Имя студента],
Case 
When (PROGRESS.NOTE = 6) then 'шесть'
When (PROGRESS.NOTE = 7) then 'семь'
When (PROGRESS.NOTE = 8) then 'восемь'
else 'Не бывать этому!'
end Оценка
...
ORDER BY PROGRESS.NOTE, STUDENT.NAME;

SELECT FACULTY.FACULTY_NAME Факультет, PULPIT.PULPIT_NAME Кафедра, SUBJECT.SUBJECT_NAME Специальность, GROUPS.FACULTY Дисциплина, STUDENT.NAME [Имя студента],
Case 
When (PROGRESS.NOTE = 6) then 'шесть'
When (PROGRESS.NOTE = 7) then 'семь'
When (PROGRESS.NOTE = 8) then 'восемь'
...
SELECT PULPIT.PULPIT_NAME Кафедра, isnull(TEACHER.TEACHER_NAME, '***') Учитель
...
ON TEACHER.PULPIT = PULPIT.PULPIT
Where PULPIT.FACULTY is Not NULL;
